...
#define HIVEMQ_USERNAME   "taist_aiot_dev_watthanai"
#define MQTT_SOUND_TOPIC  "taist/aiot/sound/dev_watthanai"
#define MQTT_HB_TOPIC     "taist/aiot/heartbeat/dev_watthanai"
#define MQTT_CMD_TOPIC    "taist/aiot/command/dev_watthanai"
