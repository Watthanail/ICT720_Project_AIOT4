...
// queue handle
QueueHandle_t evt_queue;  //-------> FreeRTOS-inter-task communication

// task function
void sound_detect_task(void *pvParameter) {
  static int32_t samples[160];   //160 * 32bit    not use simple int because there's some compiler that int take 2 byte.
